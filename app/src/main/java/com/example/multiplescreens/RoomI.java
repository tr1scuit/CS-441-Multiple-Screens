...
public class RoomI extends AppCompatActivity {

    private int roomNumber = 8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_i);
        ...
        bButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(RoomI.this, MainActivity.class);
                finish();
            }
        });
        ...
        inspButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                new AlertDialog.Builder(RoomI.this)
