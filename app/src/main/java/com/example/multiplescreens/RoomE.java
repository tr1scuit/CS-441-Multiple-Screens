...
public class RoomE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_e);
        ...
        fButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(RoomE.this, RoomG.class);
                startActivity(intent);
            }
        });
        lButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(RoomE.this, RoomF.class);
                startActivity(intent);
            }
        });
        ...
        bButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(RoomE.this, MainActivity.class);
                finish();
            }
        });
        ...
        inspButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                new AlertDialog.Builder(RoomE.this)
