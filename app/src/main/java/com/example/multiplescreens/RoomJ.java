...
public class RoomJ extends AppCompatActivity {

    private int roomNumber = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_j);
        ...
        bButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(RoomJ.this, MainActivity.class);
                finish();
            }
        });
        ...
        inspButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                new AlertDialog.Builder(RoomJ.this)
